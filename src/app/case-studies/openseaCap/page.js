...
import moonLight from "@/assets/Images/rel20.png";
...
import layerXImg from "@/assets/Images/btCash.webp";
      ...
      <main>
              ...
              <div className="ms-auto col-lg-4 col-md-6 col-12 col-sm-12">
                <div className="fullcase_details">
                  ...
                  <div className="fullCaseStudy_textContent py-4">
                    ...
                    >
                      {" "}
                      Fast, Secure, and Reliable NFT Platform
                    </h2>
          ...
          <div className="container py-5">
            <div className="row">
              <div className="col-lg-6">
                ...
                <p>
                 OpenSeaCap is your all-in-one NFT trading platform, designed
                ...
                <div className="problemstatement p-4 bg-dark text-white rounded-4">
                  ...
                  <div className="content">
                    <p className="text-white">
                     OpenSeaCap is built to make NFT trading effortless and
                      ...
                      trades to advanced security,OpenSeaCap ensures a seamless
          ...
          <div className="container py-5">
            <div className="row">
              <div className="col-lg-7">
                ...
                <p>
                 OpenSeaCap aims to revolutionize the digital finance landscape by
                  making NFT trading simple, secure, and accessible for
                  everyone.
                </p>
                <div className="row">
                  <div className="col-lg-4 col-md-6 col-sm-6 mb-3">
                    <div className="pr_goals">
                      <span>Simplify NFT Trading</span>
                    </div>
                  </div>
                  <div className="col-lg-4 col-md-6 col-sm-6 mb-3">
                    <div className="pr_goals">
        ...
        <section>
          <div className="container py-5">
            ...
            <p>
              Following the launch of the enhancedOpenSeaCap platform, the secure,
                ...
                <ul>
                  <li>
                    <p>
                      ...
                      interface and fast execution make NFT trading
          ...
          <div className="container py-5">
            <div className="row">
              ...
              <div className="col-lg-8">
                ...
                <p>
                 OpenSeaCap successfully bridges the gap between complex NFT
                ...
                <p>
                  ...
                  multi-layered security,OpenSeaCap is positioned to drive mass
                  adoption and establish a strong presence in the global NFT
                  market.
                </p>
              </div>
            </div>
